...
urlpatterns = [
    ...
    path('fetchPrivateCustomers/', views.fetch_private_customer_rides, name='fetch-private-customers'),
    path('fetchSharingCustomers/', views.fetch_sharing_customer_rides, name='fetch-sharing-customers'),
